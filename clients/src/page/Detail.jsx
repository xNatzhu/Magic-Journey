...
export default function Detail() {
  ...
  const userId = useSelector((state) => state.userReducer.user.user.id);
        ...
        {itinerary.map((element) => (
          ...
          >
            <div className="flex justify-between item-center">
              ...
              {userId ? (
                <button
                  onClick={() => onLike(element._id)}
                  className="text-[#9DC08B] flex items-center justify-center"
                >
                  <svg
                  ...
                  <p className="mx-auto">{element.likes.length}</p>
                </button>
              ) : (
