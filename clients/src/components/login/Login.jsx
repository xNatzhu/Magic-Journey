...
*/}
          <form action="" className="sm:w-2/3 w-full px-4 lg:px-0 mx-auto">
            <div className="pb-2 pt-4">
              <input type="email" name="email" id="email" placeholder="Email Address" className="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-3 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" />
            </div>
            <div className="pb-2 pt-4">
              <input type="password" name="password" id="password" placeholder="Password" className="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-3 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" />
            </div>
            <div className="flex items-center justify-between mt-6">
              <div className="flex items-center">
                <input type="checkbox" id="remember" className="text-purple-500 cursor-pointer" />
                <label htmlFor="remember" className="ml-2 text-gray-100">Recuérdame</label>
              </div>
              <div>
                <a href="#" className="inline-block align-baseline text-sm text-gray-100 hover:text-purple-500">¿Has olvidado tu contraseña?</a>
              </div>
            </div>
            <div className="mt-6">
              <button type="submit" className="group relative w-full flex justify-center py-3 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-[#9DC08B] hover:bg-[#7E9E68] focus:outline-none focus:border-purple-700 focus:shadow-outline-purple active:bg-purple-700 transition duration-150 ease-in-out">
                <span className="absolute left-0 inset-y-0 flex items-center pl-3">
                  <svg className="h-5 w-5 text-gray-100 group-hover:text-purple-300 transition ease-in-out duration-150" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M2 0C0 0 0 2 0 2v16c0 2 2 2 2 2h16c2 0 2-2 2-2V2c0-2-2-2-2-2H2C0 0 0 0 0 0zm0 1h16c1 0 1 1 1 1v2H1V2c0-1 1-1 1-1zm16 18H2c-1 0-1-1-1-1v-2h18v2c0 1-1 1-1 1zm0-3H2c-1 0-1-1-1-1V5h18v10c0 1-1 1-1 1zm-3-7H5c-1 0-1-1-1-1v-2c0-1 1-1 1-1h10c1 0 1 1 1 1v2c0 1-1 1-1 1zm1 2H4v-1c0-1 1-2 2-2h8c1 0 2 1 2 2v1z" clipRule="evenodd" />
                  </svg>
                </span>
                Ingresar
              </button>
            ...
            <p className="mt-4 text-center">
              ...
              <a href="#" className="text-[#9DC08B] hover:text-[#7E9E68]">
                Registrate
              </a>
            </p>
          </form>
